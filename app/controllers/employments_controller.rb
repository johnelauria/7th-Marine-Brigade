class EmploymentsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @employment.save
        format.html { redirect_to @employment.personal_detail, notice: 'Employment was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @employment.update_attributes(params[:employment])
        format.html { redirect_to @employment.personal_detail, notice: 'Employment was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to @employment.personal_detail }
      format.json { head :no_content }
    end
  end
end
