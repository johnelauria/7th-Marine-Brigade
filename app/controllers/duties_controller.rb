class DutiesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @duty.save
        format.html { redirect_to @duty.soi_form, notice: 'Duty was successfully created.' }
        format.json { render json: @duty, status: :created, location: @duty }
      else
        format.html { redirect_to @duty.soi_form }
  ...
  def update
    ...
    respond_to do |format|
      if @duty.update_attributes(params[:duty])
        format.html { redirect_to @duty.soi_form, notice: 'Duty was successfully updated.' }
