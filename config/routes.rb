MarineBrigade::Application.routes.draw do
  ...
  resources :received_military_awards


  resources :military_schools


  resources :important_unit_assignments
